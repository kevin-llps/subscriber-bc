...
@Builder
public record SubscriberRequestDto(@NotBlank(message = "Field 'firstname' must be non-blank")
                                   @Size(max = 100, message = "Field 'firstname' must not exceed 100 characters")
                                   @JsonProperty("firstname") String firstname,
                                   @NotBlank(message = "Field 'lastname' must be non-blank")
